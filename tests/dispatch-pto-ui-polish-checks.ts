...
assert.doesNotMatch(fleetPlacementSource, /Draft UI/);
assert.doesNotMatch(fleetPlacementSource, /источник выбора техники для Горной сводки/);
assert.match(fleetPlacementSource, /Редактировать/);
assert.match(fleetPlacementSource, /Завершить редактирование/);
...
assert.match(fleetPlacementSource, /ptoPlanRows: PtoPlanRow\[\]/);
assert.match(fleetPlacementSource, /createLocationOptionsByArea/);
assert.match(fleetPlacementSource, /updateVehiclePlacement/);
assert.doesNotMatch(fleetPlacementSource, /setVehicleRows\(\(currentRows\)|updateVehicleStatus|updateVehicleIdentity|buildVehicleDisplayName|vehicleSelectLabel/);

...
assert.match(useAppAdminReportsPrimaryContentSource, /const adminReportTabNeedsAutoRows = activeAdminReportSettingsTab === "display";/);
assert.doesNotMatch(useAppAdminReportsPrimaryContentSource, /adminReportTabNeedsAutoRows = activeAdminReportSettingsTab === "display" \|\| activeAdminReportCustomer\.autoShowRows/);
...
assert.match(useDispatchSummaryViewModelSource, /const currentDispatchShift = dispatchShiftFromTab\(dispatchTab\);/);
assert.match(useDispatchSummaryViewModelSource, /currentDispatchShift === "daily" \? search\.trim\(\)\.toLowerCase\(\) : ""/);
...
assert.match(dispatchSectionSource, /useMemo/);
assert.match(dispatchSectionSource, /resolveLegacyUserAreas/);
...
assert.match(appPrimaryContentSource, /const shouldShowPtoDatabaseGateOnly = shouldGatePtoDatabase\s*&& renderedTopTab === "pto"\s*&& activePtoTabNeedsDatabase;/);
...
assert.match(appPrimaryContentSource, /const shouldPreloadSections = renderedTopTab !== "home"\s*&& appState\.adminDataLoaded\s*&& \(!databaseConfigured \|\| ptoDatabaseReady\);/);
...
assert.match(ptoSectionSource, /ptoTab === "bodies"/);
assert.match(ptoSectionSource, /PtoBodiesSection/);
assert.match(ptoSectionSource, /ptoTab === "performance"/);
assert.match(ptoSectionSource, /PtoPerformanceSection/);
assert.match(ptoSectionSource, /ptoTab === "cycle"/);
assert.match(ptoSectionSource, /ptoCycleRows/);
assert.match(ptoSectionSource, /ptoCycleColumns/);

...
assert.match(usePtoBucketsNavigationModelSource, /const referenceRowGroupsSignature = useMemo/);
...
assert.match(usePtoBucketsNavigationModelSource, /\[isPtoBucketsSection, referenceRowGroupsSignature\]/);

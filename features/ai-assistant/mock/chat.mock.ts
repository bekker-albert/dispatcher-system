...
export const aiAssistantChatMessagesMock: AiAssistantChatMessage[] = [
    {
      ...
      role: "system",
      author: "Система",
      text: "Чат используется для вопросов, анализа и подготовки черновиков. Критические действия автоматически попадают во Входящие.",
    ...
    },
    {
      ...
      role: "assistant",
      author: "AI-ассистент",
      text: "Найдено отставание. Я подготовил черновик причины и поместил действие во Входящие, потому что текст пойдет в официальный отчет.",
